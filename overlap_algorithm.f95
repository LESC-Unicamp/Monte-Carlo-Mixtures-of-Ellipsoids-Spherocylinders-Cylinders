...
! INTEGER VARIABLES                                                                               !
! *********************************************************************************************** !
INTEGER*8 :: CI, CJ ! Counters

! *********************************************************************************************** !
! REAL VARIABLES (PARAMETER)                                                                      !
! *********************************************************************************************** !
REAL*8, PARAMETER :: TOLERANCE = 1.D-10  ! Numerical tolerance

! *********************************************************************************************** !
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                    :: LAMBDAA     ! Interpolation parameter (extremum) [a]
REAL*8                    :: LAMBDAB     ! Interpolation parameter (extremum) [b]
REAL*8                    :: LAMBDAC     ! Interpolation parameter (midpoint) [c]
REAL*8                    :: FA, FB      ! Derivatives of the interpolating function at the extrema of the interval: λ ∈ [0,1]
REAL*8                    :: FC          ! Derivative of the interpolating function at the midpoint of the considered interval
REAL*8                    :: AUX         ! Auxiliar
REAL*8                    :: INTFUNC     ! Interpolating function (Perram-Wertheim Method)
REAL*8                    :: DFUNC_DLAMB ! First derivative of the interpolating function with respect to λ (Perram-Wertheim Method)
REAL*8                    :: RIJSQ       ! Magnitude of the vector distance between particles i and j (squared)
REAL*8                    :: CONTACT_D   ! Contact distance (Perram-Wertheim Method)
REAL*8, DIMENSION( 3 )    :: RIJ         ! Vector distance between particles i and j
REAL*8, DIMENSION( 3 )    :: EXI, EXJ    ! Orientation of particles i and j along x-direction
REAL*8, DIMENSION( 3 )    :: EYI, EYJ    ! Orientation of particles i and j along y-direction
REAL*8, DIMENSION( 3 )    :: EZI, EZJ    ! Orientation of particles i and j along z-direction
REAL*8, DIMENSION( 3 )    :: SEMIAI      ! Semiaxes of particle i
REAL*8, DIMENSION( 3 )    :: SEMIBJ      ! Semiaxes of particle j
REAL*8, DIMENSION( 3 )    :: DAUX1_DLAMB ! Auxiliar (derivative)
REAL*8, DIMENSION( 3 )    :: DAUX2_DLAMB ! Auxiliar (derivative)
REAL*8, DIMENSION( 0:3 )  :: QI, QJ      ! Rotation quaternions of particle i and j
REAL*8, DIMENSION( 3, 3 ) :: EXIEXI      ! Outer product of the orientation of particle i along x-direction
REAL*8, DIMENSION( 3, 3 ) :: EYIEYI      ! Outer product of the orientation of particle i along y-direction
REAL*8, DIMENSION( 3, 3 ) :: EZIEZI      ! Outer product of the orientation of particle i along z-direction
REAL*8, DIMENSION( 3, 3 ) :: EXJEXJ      ! Outer product of the orientation of particle j along x-direction
REAL*8, DIMENSION( 3, 3 ) :: EYJEYJ      ! Outer product of the orientation of particle j along y-direction
REAL*8, DIMENSION( 3, 3 ) :: EZJEZJ      ! Outer product of the orientation of particle j along z-direction
REAL*8, DIMENSION( 3, 3 ) :: AI, BJ      ! Matrices of the semiaxes of the ellipsoids
REAL*8, DIMENSION( 3, 3 ) :: AIINV       ! Inverse matrix of the semiaxis of ellipsoid i
REAL*8, DIMENSION( 3, 3 ) :: BJINV       ! Inverse matrix of the semiaxis of ellipsoid j
REAL*8, DIMENSION( 3, 3 ) :: G, GINV     ! Auxiliary matrix G and inverse matrix G
REAL*8, DIMENSION( 3, 3 ) :: DG_DLAMB    ! Derivative of matrix G with respect to λ
REAL*8, DIMENSION( 3, 3 ) :: IDMATRIX    ! Identity matrix
...
! INTEGER VARIABLES                                                                               !
! *********************************************************************************************** !
INTEGER*8 :: CI, CJ ! Counters (component)
...
REAL*8                 :: DLAMBDA, DMU   ! Values that minimize r² (∂r²/∂μ = 0 and ∂r²/∂λ = 0)
REAL*8                 :: CC, AUXI, AUXJ ! Auxiliary variables
REAL*8                 :: RVL            ! Vega-Lago Contact Distance (variable)
REAL*8                 :: SHORTEST_D     ! Shortest distance
REAL*8                 :: SHORTEST_DSQ   ! Shortest distance (squared)
REAL*8, DIMENSION( 2 ) :: HALFLENGTH     ! Half-length of spherocylinders i and j
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                    :: LSQ            ! Cylinder geometrical length (squared)
REAL*8                    :: DSQ            ! Cylinder geometrical diameter (squared)
REAL*8                    :: RIJEI          ! Dot product of vector distance and orientation of particle i
REAL*8                    :: RIJEJ          ! Dot product of vector distance and orientation of particle j
REAL*8                    :: EIEJ           ! Dot product of both orientations (particles i and j)
REAL*8                    :: RIJSQ_PARALLEL ! Squared vector distance between particles i and j (parallel)
REAL*8                    :: RIJSQ_ORTHO    ! Squared vector distance between particles i and j (orthogonal)
REAL*8                    :: CC             ! Auxiliar variable
REAL*8, DIMENSION( 2 )    :: DSQ_DISKRIM    ! Diameter of the disk for the configuration disk-rim
REAL*8, DIMENSION( 2 )    :: HALFLENGTH     ! Half length of cylinders i and j
REAL*8, DIMENSION( 2 )    :: HALFDIAMETER   ! Half diameter of cylinders i and j
REAL*8, DIMENSION( 3 )    :: DLAMBDAEI      ! Auxiliar vector (cylinder overlap algorithm)
REAL*8, DIMENSION( 3 )    :: DMUEJ          ! Auxiliar vector (cylinder overlap algorithm)
REAL*8, DIMENSION( 3 )    :: EI, EJ         ! Orientation of particles i and j
REAL*8, DIMENSION( 3 )    :: RI, RJ         ! Position of particles i and j
REAL*8, DIMENSION( 3 )    :: RIJ            ! Vector distance between particles i and j
REAL*8, DIMENSION( 3 )    :: RIJ_PARALLEL   ! Vector distance between particles i and j (parallel)
REAL*8, DIMENSION( 3 )    :: RIJ_ORTHO      ! Vector distance between particles i and j (orthogonal)
REAL*8, DIMENSION( 3 )    :: RRIM           ! Position of cylinder rim
REAL*8, DIMENSION( 3 )    :: ERIM           ! Orientation of cylinder rim
REAL*8, DIMENSION( 0: 3 ) :: QI, QJ         ! Quaternion of particles i and j
REAL*8, DIMENSION( 0: 3 ) :: QDISK          ! Quaternion of cylinder disks
REAL*8, DIMENSION( 2, 3 ) :: DI, DJ         ! Position of both cylinder disks (i or j)
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                 :: PROJI, PROJJ ! Cylindrical projections
REAL*8, DIMENSION( 2 ) :: HALFL        ! Half length of cylinders i and j
REAL*8, DIMENSION( 3 ) :: DLAMBDAEI    ! Auxiliar vector (cylinder overlap algorithm)
REAL*8, DIMENSION( 3 ) :: DMUEJ        ! Auxiliar vector (cylinder overlap algorithm)
REAL*8, DIMENSION( 3 ) :: VECI, VECJ   ! Vector distance between the point of closest approach in one cylinder and the center of the other cylinder
REAL*8, DIMENSION( 3 ) :: EI, EJ       ! Orientation of particles i and j
REAL*8, DIMENSION( 3 ) :: RIJ          ! Vector distance between particles i and j
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                 :: DIJSQ  ! Vector distance between disks i and j (squared)
REAL*8                 :: IDIJSQ ! Magnitude of the shortest distance between disk i and intersection line between planes of the disks
REAL*8                 :: JDIJSQ ! Magnitude of the shortest distance between disk j and intersection line between planes of the disks
REAL*8                 :: SPH_SQ ! Magnitude of the vector distance between the circumscribing spheres (squared)
REAL*8                 :: SEG    ! Segment (sum)
REAL*8                 :: SEGI   ! Segment of cylinder i
REAL*8                 :: SEGJ   ! Segment of cylinder j
REAL*8                 :: CC     ! Auxiliar variable
REAL*8                 :: MODEIJ ! Magnitude of vector eij
REAL*8                 :: PIPJ   ! Projection of dij on eij
REAL*8, DIMENSION( 2 ) :: RSQ    ! Radius of cylinders i and j (squared)
REAL*8, DIMENSION( 2 ) :: HALFD  ! Half diameter of cylinders i and j
REAL*8, DIMENSION( 3 ) :: DIJ    ! Vector distance between disks i and j
REAL*8, DIMENSION( 3 ) :: EI, EJ ! Orientation of particles i and j
REAL*8, DIMENSION( 3 ) :: EIJ    ! Cross product of orientations of particles i and j
REAL*8, DIMENSION( 3 ) :: UEIJ   ! Versor of vector eij
REAL*8, DIMENSION( 3 ) :: DI, DJ ! Position of both disks of cylinders (particles) i and j
...
! INTEGER VARIABLES                                                                               !
! *********************************************************************************************** !
INTEGER*8                 :: COUNTER                   ! Iteration counter (numerical methods)
INTEGER*8                 :: COUNTERB                  ! Cycles of the bissection method
INTEGER*8                 :: INTERVAL                  ! Loop over λ intervals

! *********************************************************************************************** !
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                    :: DKRRIM_ERIM               ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder rim (i or j)
REAL*8                    :: DKRRIM_EXDISK             ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder disk along x-direction (j or i)
REAL*8                    :: DKRRIM_EYDISK             ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder disk along y-direction (j or i)
REAL*8                    :: EXDISK_ERIM               ! Dot product of the orientation of the cylinder disk (j or i) along x-direction and the orientation of the cylinder rim (i or j)
REAL*8                    :: EYDISK_ERIM               ! Dot product of the orientation of the cylinder disk (j or i) along y-direction and the orientation of the cylinder rim (i or j)
REAL*8                    :: DKURIMSQ                  ! Magnitude of the vector distance between the closest point on the cylinder rim (i or j) and the center of the cylinder disk (j or i)
REAL*8                    :: DAMPING                   ! Damping factor of the Newton-Raphson method
REAL*8                    :: TOLERANCE_NR, TOLERANCE_B ! Numerical tolerance of the Newton-Raphson and bissection methods
REAL*8                    :: FACTOR                    ! Newton-Raphson's factor (function over its derivative)
REAL*8                    :: COSPHI, SINPHI            ! Cossine and sine of the angle φ that defines a point in the circumference of the cylinder disk (j or i)
REAL*8                    :: OPPOSITE_CAT              ! Opposite cathetus
REAL*8                    :: ADJACENT_CAT              ! Adjacent cathetus
REAL*8                    :: HYP                       ! Hypothenuse
REAL*8                    :: TPARALSQ                  ! Magnitude of vector T parallel to the cylinder rim (i or j) (squared)
REAL*8                    :: TORTHOSQ                  ! Magnitude of vector T orthogonal to the cylinder rim (i or j) (squared)
REAL*8                    :: TSQ                       ! Magnitude of the vector T (squared)
REAL*8                    :: FI                        ! Objective function (midpoint)
REAL*8                    :: DFI                       ! Derivative of the objective function with respect to λ (midpoint)
REAL*8                    :: LAMBDAI                   ! Minimization variable related to a point on the cylinder rim (i or j) (midpoint)
REAL*8                    :: RSQ                       ! Radius of the cylinder (squared)
REAL*8                    :: DSQ                       ! Diameter of the combined cylinder disks (squared)
REAL*8                    :: HALFDDISK                 ! Half diameter of the cylinder disk
REAL*8                    :: HALFDRIM                  ! Half diameter of the cylinder rim
REAL*8                    :: HALFLRIM                  ! Half length of the cylinder rim
REAL*8, DIMENSION( 3 )    :: F                         ! Objective function
REAL*8, DIMENSION( 3 )    :: DF                        ! Derivative of the objective function with respect to λ
REAL*8, DIMENSION( 3 )    :: LAMBDA                    ! Minimization variable related to a point on the cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: RRIM                      ! Position of the cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: ERIM                      ! Orientation of the cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: EXDISK, EYDISK            ! Orientation of the cylinder disks along x- and y-directions (j or i)
REAL*8, DIMENSION( 3 )    :: DK                        ! Position of cylinder disks (j or i)
REAL*8, DIMENSION( 3 )    :: DKRRIM                    ! Vector distance between a cylinder disk (j or i) and a cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: DKURIM                    ! Vector distance between a cylinder disk (j or i) and the closest point on the cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: URIM                      ! Closest point on the cylinder rim (i or j) with respect to the center of the cylinder disk (j or i)
REAL*8, DIMENSION( 3 )    :: PC                        ! Closest point on the axial axis of the cylinder rim (i or j) with respect to the circumference of the cylinder disk (j or i)
REAL*8, DIMENSION( 3 )    :: PD                        ! Closest point on the circumference of the cylinder disk (j or i) with respect to the axial axis of the cylinder rim (i or j)
REAL*8, DIMENSION( 3 )    :: T                         ! Vector distance between the closest point on the circumference of the cylinder disk (j or i) and the center of the cylinder rim (i or j)
REAL*8, DIMENSION( 0: 3 ) :: QDISK                     ! Quaternion of the cylinder disks (j or i)
...
! *********************************************************************************************** !
!  First loop : λ0 = -L/2, for NEWTON-RAPHSON method, and -L/2 <= λ0 <= 0, for BISSECTION method  !
!  Second loop: λ0 =  L/2, for NEWTON-RAPHSON method, and  0 <= λ0 <= L/2, for BISSECTION method  !
! *********************************************************************************************** !
LOOP_INTERVAL: DO INTERVAL = 1, 2

  ! Initial parameters of the Newton-Raphson method
  DAMPING       = 0.5D0   ! Damping factor
  COUNTER       = 0       ! Iteration counter
  TOLERANCE_NR  = 1D-10   ! Numerical tolerance
  BISECT_METHOD = .FALSE. ! Bissection after Newton-Raphson method

  ! Initial guess, λ0 (Newton-Raphson)
  LAMBDA(1) = DBLE( (2 * INTERVAL) - 3) * HALFLRIM

  CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDA(1), &
  &                        HALFDDISK, F(1), DF(1) )
  ...
  DO WHILE ( DABS( F(1) ) >= TOLERANCE_NR .AND. .NOT. BISECT_METHOD)
    ...
    ! Recalculate function ans its derivative with respect to λ
    CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDA(1), &
    &                        HALFDDISK, F(1), DF(1) )
    ! Iteration
    COUNTER = COUNTER + 1
  ...
  IF( BISECT_METHOD ) THEN
    ...
    ELSE IF( INTERVAL == 2 ) THEN
      ...
      LAMBDA(3) = HALFLRIM
    END IF
    ! Calculate function and its derivative at the extremum points
    CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDA(2), &
    &                        HALFDDISK, F(2), DF(2) )
    CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDA(3), &
    &                        HALFDDISK, F(3), DF(3) )
    ! Bissection condition
    IF( ( F(2) * F(3) ) < 0.D0 ) THEN
      ! Midpoint λ
      LAMBDAI = 0.5D0 * ( LAMBDA(2) + LAMBDA(3) )
      ! Calculate function and its derivative at the midpoint
      CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDAI, &
      &                        HALFDDISK, FI, DFI )
      ! Bissection method
      DO WHILE( DABS(FI) >= TOLERANCE_B )
        ...
        ! New midpoint λ
        LAMBDAI = 0.5D0 * ( LAMBDA(2) + LAMBDA(3) )
        ! Calculate function and its derivative at the new midpoint
        CALL OBJECTIVE_FUNCTION( EYDISK_ERIM, DKRRIM_EYDISK, EXDISK_ERIM, DKRRIM_EXDISK, DKRRIM_ERIM, LAMBDAI, &
        &                        HALFDDISK, FI, DFI )
        ! Iteration
        COUNTERB = COUNTERB + 1
  ...
  ! ********************************************************************************************* !
  !   λ = λroot [either NEWTON-RAPHSON or BISSECTION methods]                                     !
  ! ********************************************************************************************* !
  OPPOSITE_CAT = LAMBDA(1) * EYDISK_ERIM - DKRRIM_EYDISK 
  ADJACENT_CAT = LAMBDA(1) * EXDISK_ERIM - DKRRIM_EXDISK 
  HYP          = DSQRT( (OPPOSITE_CAT * OPPOSITE_CAT) + (ADJACENT_CAT * ADJACENT_CAT) )
...
!                                       Objective Function                                        !
! *********************************************************************************************** !
SUBROUTINE OBJECTIVE_FUNCTION( EYD_ER, DR_EYD, EXD_ER, DR_EXD, DR_ER, LAMBDA, HALFD, FUNC, DF )
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8 :: EYD_ER  ! Dot product of the orientation of the cylinder disk (j or i) along y-direction and the orientation of the cylinder rim (i or j)
REAL*8 :: DR_EYD  ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder disk along y-direction (j or i)
REAL*8 :: EXD_ER  ! Dot product of the orientation of the cylinder disk (j or i) along x-direction and the orientation of the cylinder rim (i or j)
REAL*8 :: DR_EXD  ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder disk along x-direction (j or i)
REAL*8 :: DR_ER   ! Dot product of the vector distance between a disk (j or i) and a rim (i or j) and the orientation of the cylinder rim (i or j)
REAL*8 :: FUNC    ! Objective function
REAL*8 :: DF      ! Derivative of the objective function with respect to λ (midpoint)
REAL*8 :: OPP_CAT ! Opposite cathetus
REAL*8 :: ADJ_CAT ! Adjacent cathetus
REAL*8 :: HYP     ! Hypothenuse
REAL*8 :: COSPHI  ! Cossine of the angle φ that defines a point in the circumference of the cylinder disk (j or i)
REAL*8 :: SINPHI  ! Sine of the angle φ that defines a point in the circumference of the cylinder disk (j or i)
REAL*8 :: LAMBDA  ! Minimization variable related to a point on the cylinder rim (i or j)
REAL*8 :: AUX1    ! Derivate of cossine with respect to λ
REAL*8 :: AUX2    ! Derivate of sine with respect to λ
REAL*8 :: HALFD   ! Half-diameter of cylinder

! Opposite cathetus
OPP_CAT = (LAMBDA * EYD_ER) - DR_EYD
! Adjacent cathetus
ADJ_CAT = (LAMBDA * EXD_ER) - DR_EXD
! Hypothenuse
HYP     = DSQRT( (OPP_CAT * OPP_CAT) + (ADJ_CAT * ADJ_CAT) )
! Cossine of the angle φ (trigonometric relations in a rectangle triangle)
COSPHI  = ADJ_CAT / HYP
! Sine of the angle φ (trigonometric relations in a rectangle triangle)
SINPHI  = OPP_CAT / HYP
! Objective function
FUNC    = LAMBDA - (HALFD * COSPHI * EXD_ER) - (HALFD * SINPHI * EYD_ER) - DR_ER
! Auxiliar (derivate of cossine with respect to λ)
AUX1    = HALFD * EXD_ER * OPP_CAT * ( (EXD_ER * DR_EYD) - (EYD_ER * DR_EXD) )
AUX1    = AUX1 / (HYP * HYP * HYP)
! Auxiliar (derivate of sine with respect to λ)
AUX2    = HALFD * EYD_ER * ADJ_CAT * ( (EYD_ER * DR_EXD) - (EXD_ER * DR_EYD) )
AUX2    = AUX2 / (HYP * HYP * HYP)
! Derivate of the objective function with respect to λ
DF      = 1.D0 + AUX1 + AUX2
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8, DIMENSION( 3 )    :: EI, EJ ! Vectors
REAL*8, DIMENSION( 3, 3 ) :: EIJ    ! Cross product of vectors
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                    :: DET, RDET ! Determinant
REAL*8, DIMENSION( 3, 3 ) :: A         ! Matrix
REAL*8, DIMENSION( 3, 3 ) :: B         ! Matrix (inverse)
