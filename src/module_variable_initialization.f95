...
WRITE( 105, * ) "Number_of_Particles: ", nParticles
WRITE( 105, * ) "Number_of_Components: ", nComponents
WRITE( 105, * ) "Cell_List_Inquiry: ", CellListLogical
WRITE( 105, * ) "Potential_Type_Logical: ", PotentialTypeLogical
IF( PotentialTypeLogical(2) ) THEN
  WRITE( 105, * ) "Number_of_Potential_Ranges: ", nRange
  WRITE( 105, * ) "Potential_Ranges: ", PotentialRange
  WRITE( 105, * ) "Reduced_Temperature: ", ReducedTemperature
  WRITE( 105, * ) "Min_Blocks: ", MinBlocks
  WRITE( 105, * ) "Max_Blocks: ", MaxBlocks
END IF
WRITE( 105, * ) "Geometry_Inquiry: ", "'"//TRIM( GeometryInquiry )//"'"
WRITE( 105, * ) "Molecular_Geometry: ", "'"//TRIM( MolecularGeometry )//"'"
WRITE( 105, * ) "Geometry_Acronym: ", "'"//TRIM( GeometryAcronym )//"'"
WRITE( 105, "(G0,3(G0,1X))" ) "Geometry_Type: ", GeometryType
WRITE( 105, * ) "Configuration_Inquiry: ", "'"//TRIM( ConfigurationInquiry )//"'"
WRITE( 105, * ) "Initial_Configuration: ", "'"//TRIM( InitialConfiguration )//"'"
WRITE( 105, "(G0,5(G0,1X))" ) "Configuration_Selection: ", ConfigurationSelection
WRITE( 105, * ) "Max_Simulation_Cycles: ", MaxSimulationCycles
WRITE( 105, * ) "Number_of_Equilibration_Cycles: ", nEquilibrationCycles
WRITE( 105, * ) "Saving_Frequency: ", nSavingFrequency
WRITE( 105, * ) "Adjustment_Frequency: ", nAdjustmentFrequency
WRITE( 105, * ) "Adjustment_Frequency_Random_Config: ", nAdjustmentRandomConfig
WRITE( 105, * ) "User_Max_Translational_Displacement: ", UserMaxTranslationalDisplacement
WRITE( 105, * ) "Max_Translational_Displacement_Random_Config: ", MaxTranslationalDisplacementRandomConfig
WRITE( 105, * ) "User_Max_Rotational_Displacement: ", UserMaxRotationalDisplacement
WRITE( 105, * ) "Max_Angular_Displacement_Random_Config: ", MaxAngularDisplacementRandomConfig
WRITE( 105, * ) "User_Max_Iso_Volumetric_Displacement: ", UserMaxIsoVolumetricDisplacement
WRITE( 105, * ) "User_Max_Aniso_Volumetric_Displacement: ", UserMaxAnisoVolumetricDisplacement
WRITE( 105, * ) "Max_Iso_Volumetric_Displacement_Random_Config: ", MaxIsoVolumetricDisplacementRandomConfig
WRITE( 105, * ) "Max_Aniso_Volumetric_Displacement_Random_Config: ", MaxAnisoVolumetricDisplacementRandomConfig
WRITE( 105, * ) "Min_Volumetric_Displacement_Random_Config: ", MinVolumetricDisplacementRandomConfig
WRITE( 105, * ) "Max_Box_Distortion: ", MaxBoxDistortion
WRITE( 105, * ) "Box_Edge_Max_Ratio: ", BoxEdgeMaxRatio
WRITE( 105, * ) "Box_Vector_Max_Angle: ", BoxVectorMaxAngle
WRITE( 105, * ) "Lattice_Reduction_Type: ", "'"//TRIM( LatticeReductionType )//"'"
WRITE( 105, "(G0,2(G0,1X))" ) "Lattice_Reduction_Type_Logical: ", LatticeReductionTypeLogical
WRITE( 105, * ) "Ensemble_MC: ", "'"//TRIM( EnsembleMC )//"'"
WRITE( 105, * ) "Trajectory_Inquiry: ", "'"//TRIM( TrajectoryInquiry )//"'"
WRITE( 105, * ) "Trajectory_Logical: ", TrajectoryLogical
WRITE( 105, * ) "Seed_Type_Inquiry: ", "'"//TRIM( SeedTypeInquiry )//"'"
WRITE( 105, * ) "Fixed_Seed_Logical: ", FixedSeedLogical
WRITE( 105, * ) "Backup_File_Inquiry: ", "'"//TRIM( BackupFileInquiry )//"'"
WRITE( 105, * ) "Backup_File_Logical: ", BackupFileLogical
WRITE( 105, * ) "Potential_Type: ", "'"//TRIM( PotentialType )//"'"
IF( PotentialTypeLogical(2) ) THEN
  WRITE( 105, * ) "Potential_Energy_Inquiry: ", "'"//TRIM( PotentialEnergyInquiry )//"'"
  WRITE( 105, * ) "Potential_Energy_Logical: ", PotentialEnergyLogical
  WRITE( 105, * ) "Perturbation_Coefficient_Inquiry: ", "'"//TRIM( PerturbationCoefficientInquiry )//"'"
  WRITE( 105, * ) "Perturbation_Coefficient_Logical: ", PerturbationCoefficientLogical
END IF
WRITE( 105, * ) "Spherical_Component_Logical: ", SphericalComponentLogical
WRITE( 105, * ) "Diameter_of_Component: ", cDiameter
WRITE( 105, * ) "Length_of_Component: ", cLength
WRITE( 105, * ) "Molar_Fraction_of_Component: ", cMolarFraction
WRITE( 105, * ) "Aspect_Ratio_of_Component: ", cAspectRatio
WRITE( 105, * ) "Number_of_Particles_of_Component: ", cParticles
WRITE( 105, * ) "Molecular_Volume_of_Component: ", cMolecularVolume
WRITE( 105, * ) "Total_Particle_Volume: ", TotalParticleVolume
WRITE( 105, * ) "Number_Density_of_Component: ", cNumberDensity
WRITE( 105, * ) "Absolute_Temperature: ", AbsoluteTemperature
WRITE( 105, * ) "Reduced_Pressure: ", ReducedPressure
WRITE( 105, * ) "Body_Fixed_Axis_Inquiry: ", "'"//TRIM( BodyFixedAxisInquiry )//"'"
WRITE( 105, "(G0,3(G0,1X))" ) "Axis_Selection: ", AxisSelection
WRITE( 105, * ) "Quaternion_Angle: ", QuaternionAngle
WRITE( 105, * ) "Packing_Fraction_Initial_Configuration: ", PackingFractionInitialConfiguration
WRITE( 105, * ) "Pressure_Random_Config: ", PressureRandomConfig
WRITE( 105, * ) "Preset_Initial_Configuration: ", PresetInitialConfiguration
WRITE( 105, * ) "Acceptance_Ratio_Translation: ", AcceptanceRatioTranslation
WRITE( 105, * ) "Acceptance_Ratio_Rotation: ", AcceptanceRatioRotation
WRITE( 105, * ) "Acceptance_Ratio_Iso_Volume_Change: ", AcceptanceRatioIsoVolumeChange
WRITE( 105, * ) "Acceptance_Ratio_Aniso_Volume_Change: ", AcceptanceRatioAnisoVolumeChange
WRITE( 105, * ) "Movement_Probability: ", MovementProbability
WRITE( 105, * ) "Volume_Change_Probability: ", VolumeChangeProbability
WRITE( 105, * ) "Movement_Probability_Random_Config: ", MovementProbabilityRandomConfig
WRITE( 105, * ) "Volume_Change_Probability_Random_Config: ", VolumeChangeProbabilityRandomConfig
WRITE( 105, * ) "Translational_Probability: ", TranslationalProbability
WRITE( 105, * ) "Rotational_Probability: ", RotationalProbability
WRITE( 105, * ) "Translational_Probability_Random_Config: ", TranslationalProbabilityRandomConfig
WRITE( 105, * ) "Rotational_Probability_Random_Config: ", RotationalProbabilityRandomConfig
WRITE( 105, * ) "IsoVolumetric_Probability: ", IsoVolumetricProbability
WRITE( 105, * ) "Aniso_Volumetric_Probability: ", AnisoVolumetricProbability
WRITE( 105, * ) "Iso_Volumetric_Probability_Random_Config: ", IsoVolumetricProbabilityRandomConfig
WRITE( 105, * ) "Aniso_Volumetric_Probability_Random_Config: ", AnisoVolumetricProbabilityRandomConfig
WRITE( 105, * ) "Initial_Seed: ", InitialSeed
WRITE( 105, * ) "Date_Time: ", DateTime
WRITE( 105, * ) "Descriptor_Date: ", DescriptorDate
WRITE( 105, * ) "Descriptor_Hour: ", DescriptorHour
WRITE( 105, * ) "Descriptor_File_Thermo_Variable: ", DescriptorFileThermoVariable
WRITE( 105, * ) "Descriptor_File_Components: ", DescriptorFileComponents
WRITE( 105, * ) "Descriptor_File_Geometry: ", "'"//TRIM( DescriptorFileGeometry )//"'"
CLOSE( 105 )
...
! *********************************************************************************************** !
SUBROUTINE RestoreBackupVariables( DescriptorBackup, DateTime )
...
! CHARACTER STRINGS                                                                               !
! *********************************************************************************************** !
CHARACTER( LEN= 14 ) :: DescriptorBackup ! Descriptor for output file

! Backup file of common variables from previous simulations
OPEN( Unit= 105, File= "Backup/"//TRIM( DescriptorBackup )//"_variables.backup", Action= "READ" )
! Skip
READ( 105, * )
READ( 105, * )
READ( 105, * )
