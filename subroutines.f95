...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8, DIMENSION( 3 )    :: EFIXED ! Body-fixed orientation
REAL*8, DIMENSION( 3 )    :: EP     ! Space-fixed orientation
REAL*8, DIMENSION( 0:3 )  :: QP     ! Rotation quaternion
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                   :: ANGLE ! Maximum angular displacement
REAL*8, DIMENSION( 0:3 ) :: QM    ! Reference rotation quaternion
REAL*8, DIMENSION( 0:3 ) :: QR    ! Random quaternion
REAL*8, DIMENSION( 0:3 ) :: QN    ! Composed rotation quaternion
...
! *********************************************************************************************** !
INTEGER*8 :: I, J      ! Counters
INTEGER*8 :: C, CI, CJ ! Component indexes

! *********************************************************************************************** !
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                          :: RIJSQ     ! Magnitude of the vector distance between particles i and j (squared)
REAL*8                          :: CONTACT_D ! Contact distance (Perram-Wertheim or Vega-Lago Methods)
...
REAL*8, DIMENSION( 9 )          :: BL        ! Box length
REAL*8, DIMENSION( 9 )          :: BLI       ! Box length (inverse)
...
INTEGER*8 :: N_S         ! Non-spherical particles counter
...
REAL*8, DIMENSION( 3 )              :: EIGENVECTOR ! Eigenvector of order tensor Q
...
REAL*8, DIMENSION( 3, N_PARTICLES ) :: EP          ! Order tensor Q of particle i (Average)
...
! REAL VARIABLES                                                                                  !
! *********************************************************************************************** !
REAL*8                 :: DET  ! Determinant (volume)
REAL*8                 :: RDET ! Determinant (inverse)
REAL*8, DIMENSION( 9 ) :: A    ! Box length
REAL*8, DIMENSION( 9 ) :: B    ! Box length (inverse)
...
! *********************************************************************************************** !
REAL*8, DIMENSION( 9 ) :: A ! Box length
REAL*8, DIMENSION( 3 ) :: B ! Vector distance (original)
REAL*8, DIMENSION( 3 ) :: C ! Vector distance (transformation)
...
! *********************************************************************************************** !
INTEGER*8 :: J     ! Counter
INTEGER*8 :: TOTAL ! Total/Maximum number of cycles
